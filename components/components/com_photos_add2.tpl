...
<form id="usr_photos_upload_form" action="" method="post" enctype="multipart/form-data">
    ...
    {/if}
        ...
        <div>
            ...
            <input id="btnCancel" type="button" class="btn" value="Отменить все" onclick="swfu.cancelQueue();" disabled="disabled" style="margin-left: 2px; font-size: 8pt; height: 36px;" />
        </div>
...
{elseif $uload_type == 'single'}
        ...
        <form enctype="multipart/form-data" action="{$upload_url}" method="POST">
            ...
            <p>
                <input type="submit" class="btn" value="{$LANG.LOAD}">
