        ...
        <table class="cmm_entry">
			<tr>
				<td class="cmm_title" valign="middle">
                    ...
                    <span class="cmm_date"><i class="bac-date"></i> {if $comment.published}{$comment.fpubdate}{else}<span style="color:#F00">{$LANG.WAIT_MODERING}</span>{/if}</span>
                    ...
                    {else}
                        <span class="cmm_votes" id="votes{$comment.id}">
                            ...
                            <td><a href="javascript:void(0);" onclick="voteComment({$comment.id}, -1);" title="{$LANG.BAD_COMMENT}"><i class="icon-thumbs-down"></i></a></td>
                            <td><a href="javascript:void(0);" onclick="voteComment({$comment.id}, 1);" title="{$LANG.GOOD_COMMENT}"><i class="icon-thumbs-up"></i></a></td>
                            </tr></table>
                        </span>
                    {/if}
				</td>
