...
<form action="" method="post" enctype="multipart/form-data" name="uploadform">
  ...
  <div style="margin-top:20px;overflow:hidden">
    <input style="float:left;margin-right:4px" type="button" class="btn" name="upload_btn" id="upload_btn" value="{$LANG.UPLOAD_FILES}" onclick="startUpload()"/>
    <input style="float:left" type="button" class="btn" name="cancel_btn" id="cancel_btn" value="{$LANG.CANCEL}" onclick="window.history.go(-1)" />
    <div id="loadergif" style="display:none;float:left;margin:6px"><img src="/images/ajax-loader.gif"></div>
  </div>
...
<div style="margin-top:20px">
  <input type="button" class="btn" name="cancel" value="{$LANG.CANCEL}" onclick="window.history.go(-1)" />
</div>
{/if} 