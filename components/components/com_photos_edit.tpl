...
<table width="100%" border="0" cellspacing="0" cellpadding="3" style="margin:10px">
  <tr>
    ...
    <td><input name="title" type="text" size="40" maxlength="250" style="width:350px" value="{$photo.title|escape:'html'}"/></td>
  </tr>
  <tr>
...
{if !$no_tags}
  <tr>
    ...
    <td><input name="tags" type="text" style="width:350px" size="40" value="{$photo.tags|escape:'html'}"/><br /><span><small>{$LANG.KEYWORDS}</small></span></td>
  </tr>
{/if}
  <tr>
    <td valign="top"><strong>{$LANG.REPLACE_FILE}:</strong></td>
    <td><input name="Filedata" type="file" style="width:350px" /><br><br><img alt="" src="/images/photos/small/{$photo.file}" border="0" /></td>
  </tr>
{if $is_admin}
  <tr>
