...
<form action="" method="POST" name="addform" id="addform">
  ...
  <div style="margin-top:6px;">
    <input type="submit" class="btn" name="gosend" value="{$LANG.TO_AWARD}" style="font-size:16px"/>
    <input type="button" class="btn" name="gosend" value="{$LANG.CANCEL}" style="font-size:16px" onclick="window.history.go(-1)"/>
  </div>
</form>
