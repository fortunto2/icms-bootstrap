...
<table class="forums_table" width="100%" cellspacing="0" cellpadding="8" border="0" bordercolor="#999999" >
    ...
    {foreach key=fid item=forum from=$forums}
        ...
        <tr>
            <td width="32" class="{$class}" align="center" valign="top"><img src="{$forum.icon_url}"></td>
            ...
            <td class="{$class}" style="font-size:11px; padding-right: 30px; text-align: right" valign="top">
