...
<div class="usr_photos_notice"><i class="icon-info-sign"></i> {$LANG.PHOTO_PLEASE_NOTE}</div>
<form action="" method="POST">
	<table width="550" cellpadding="4">
		<tr>
			<td width="180" id="text_title"><strong>{$LANG.PHOTO_TITLE}:</strong></td>
			<td>
				<input name="title" type="text" id="title" style="width:350px;" maxlength="250" value="{$mod.title|escape:'html'}" />
			</td>
		</tr>
		<tr>
		...
		<tr>
		    ...
		    <input type="submit" class="btn" name="submit" id="text_subm" value="{$LANG.GO_TO_UPLOAD}" /> <input id="only_mod" name="only_mod" type="checkbox" value="1" onclick="mod_text()" />  <label for="only_mod">{$LANG.ADD_MULTY}</label></td>
		</tr>
	</table>							
</form>