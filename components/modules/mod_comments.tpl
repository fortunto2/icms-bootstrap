...
{/foreach}
{if $cfg.showrss}
	<div style="margin-top:15px"> <a href="/rss/comments/all/feed.rss" class="mod_latest_rss"><i class="bac-share"> </i> {$LANG.COMMENTS_RSS}</a> </div>
{/if}
<div style="margin-top:5px"> <a href="/comments" class="mod_com_all"><i class="icon-comment"></i> {$LANG.COMMENTS_ALL}</a> </div>
