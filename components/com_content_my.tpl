...
<div class="float_bar">
    <a href="/content/add.html" class="usr_article_add"><i class="icon-plus-sign"></i> {$LANG.ADD_ARTICLE}</a>
</div>
...
<table width="100%" cellpadding="8" cellspacing="0" border="0" class="art_list">
	...
	{foreach key=tid item=article from=$articles}
		<tr>
			...
			<td align="center">
				<a href="/content/edit{$article.id}.html" title="{$LANG.EDIT}"><i class="icon-pencil"></i></a>
				{if $user_can_delete}
					<a href="/content/delete{$article.id}.html" title="{$LANG.DELETE}"><i class="icon-minus-sign"></i></a>
				{/if}
			</td>
		</tr>			
	{/foreach}
