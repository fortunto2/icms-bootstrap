...
<form id="editform" name="editform" method="post" action="">
            ...
            <div id="about">
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td valign="top"><input name="nickname" type="text" id="nickname" style="width:300px" value="{$usr.nickname|escape:'html'}"/></td>
                    </tr>
                    <tr>
	...
	<div style="padding:5px; padding-bottom:15px; margin-bottom:5px;">
		<input style="font-size:16px" name="save" type="submit" class="btn" id="save" value="{$LANG.SAVE}" />
        <input style="font-size:16px" name="chpassbtn" type="button" class="btn" id="chpassbtn" value="{$LANG.CHANGE_PASS}" onclick="{literal}$('div#change_password').slideToggle();{/literal}" />
		<input style="font-size:16px" name="delbtn2" type="button" class="btn" id="delbtn2" value="{$LANG.DEL_PROFILE}" onclick="location.href='/users/{$usr.id}/delprofile.html';" />
	</div>
</form>
...
<div id="change_password" style="display:none">
    ...
    <form id="editform" name="editform" method="post" action="">
        ...
        <div style="padding:5px; padding-bottom:15px; margin-bottom:20px;">
            <input style="font-size:16px" name="save2" type="submit" class="btn" id="save2" value="{$LANG.CHANGE_PASSWORD}" />
        </div>
    </form>
</div>